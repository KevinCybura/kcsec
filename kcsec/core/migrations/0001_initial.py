    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ad', 'ad'), ('re', 're'), ('ce', 'ce'), ('si', 'si'), ('lp', 'lp'), ('cs', 'cs'), ('et', 'et'), ('wt', 'wt'), ('oef', 'oef'), ('cef', 'cef'), ('ps', 'ps'), ('ut', 'ut'), ('temp', 'temp')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('symbol', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='core.symbol')),
                ('date', models.DateField()),
                ('is_enabled', models.BooleanField()),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('symbol', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='core.symbol')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iex_id', models.CharField(max_length=25)),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.currency')),
                ('exchange', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.internationalexchange')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.DateTimeField(auto_now=True)),
                ('symbol', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ('from_currency', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, related_name='from_currency', to='core.currency')),
                ('to_currency', models.ForeignKey(max_length=10, on_delete=django.db.models.deletion.CASCADE, related_name='to_currency', to='core.currency')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('date', models.DateField()),
                ('type', models.CharField(choices=[('ad', 'ad'), ('re', 're'), ('ce', 'ce'), ('si', 'si'), ('lp', 'lp'), ('cs', 'cs'), ('et', 'et'), ('wt', 'wt')], max_length=3)),
                ('region', models.CharField(max_length=25)),
                ('iex_id', models.CharField(max_length=20)),
                ('currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.currency')),
            ],
