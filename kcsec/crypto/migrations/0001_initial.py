    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol_type', models.CharField(choices=[('SPOT', 'Spot'), ('FUTURES', 'Futures'), ('OPTION', 'Option'), ('PERPETUAL', 'Perpetual'), ('INDEX', 'Index'), ('CREDIT', 'Credit')], max_length=10)),
                ('data_start', models.DateField()),
                ('data_end', models.DateField()),
                ('data_quote_start', models.DateTimeField()),
                ('data_quote_end', models.DateTimeField()),
                ...
                ('asset_id_base', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='base', to='crypto.asset')),
                ('asset_id_quote', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='quote', to='crypto.asset')),
                ('asset_id_unit', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='unit', to='crypto.asset')),
